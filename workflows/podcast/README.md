...
默认片头 5 秒、片尾 6 秒，可分别选择 `default`、`none` 或 [音乐素材文件夹](../../assets/podcast/music/) 中的文件。支持正文背景音乐、音量设置及片头片尾时长设置。音乐循环/裁剪并淡入淡出。详见 [文稿规范](SCRIPT_SPEC.md#选择片头片尾及正文背景音乐)。旧文稿默认不铺正文背景音乐。
